...
class Video extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['thumbnail', 'image', 'minWidth' => 1000],
            ['video', 'file', 'extensions' => ['mp4', 'mkv']],
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if ($this->thumbnail) {
            ...
            \yii\imagine\Image::getImagine()->open($thumbnailPath)->thumbnail(new \Imagine\Image\Box(1280, 1280))->save();
        }
